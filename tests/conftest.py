...
_stub("services.market.scout_vision", **_vision_stub)
...
_stub("services.market.brands", **brands_attrs)
...
_stub("services.market.site_catalog", get_site_vote=_stub_site_vote, warmup=_stub_warmup)
