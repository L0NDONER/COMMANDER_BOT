...
Usage (via master CLI):
    python3 scripts/corrections/dispatch/dispatch.py radial < manifest.txt
    python3 scripts/corrections/dispatch/dispatch.py radial --home "NR19 1AA" < manifest.txt

Or run directly:
    echo "NR19 2BB NR19 1AD NR19 2ET" | python3 scripts/corrections/dispatch/outside_in.py
